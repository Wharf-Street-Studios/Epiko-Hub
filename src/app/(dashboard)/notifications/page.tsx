...
const NotificationItem = ({ icon: Icon, title, desc, time, color, id }: any) => (
  <motion.div 
    layout
    key={id}
  ...
  >
    ...
    <div className="flex-1 min-w-0">
      <div className="flex justify-between items-start mb-1 gap-4">
         <h3 className="font-bold text-white text-base group-hover:text-[#866bff] transition-colors truncate">{title}</h3>
